...
//   return (
//     <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-teal-900 via-teal-700 to-teal-600 font-montserrat p-4">
    ...
    //           <Link href="/forgot-password" className="text-[#4ecde6] hover:underline">
    //             Forgot Password?
    //           </Link>
    //         </div>
    //       </div>
    ...
    //       Don&apos;t have account?{" "}
    //       <Link href="/signup" className="text-[#4ecde6] hover:underline font-medium">
    //         Sign Up Now
    //       </Link>
    //     </div>
    //   </div>
